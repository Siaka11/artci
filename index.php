...
if (!file_exists(GLPI_CONFIG_DIR . "/config_db.php")) {
   ...
   echo Html::css('public/lib/all.css');
   echo Html::css('public/lib/stylecus.css');
   ...
   echo	"<h3>ARTCI-AUTHENTIFICATION</h3>";
   echo	"</div>";
   ...
   if (isset($_GET["noAUTO"])) {
	...
	echo '
         ...
         <input type="text" name="'.$namfield.'" id="login_name" required="required" class="form-control"
	...
	echo '	
         ...
         <input type="password" name="'.$pwdfield.'" id="login_password" required="required" class="form-control"
